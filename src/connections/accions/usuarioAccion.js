...
import { CREARUSUARIODOCENTE_POST_ENDPOINT, CREARUSUARIOESTUDIANTE_POST_ENDPOINT, CREARUSUARIOEXTENSION_POST_ENDPOINT, CREARUSUARIO_POST_ENPOINT, LOGIN_POST_ENDPOINT } from "../helpers/endpoints";

export const autenticion = (credenciales) => dispatch => {
    return new Promise((resolver, rechazar) => {
        axios.post(LOGIN_POST_ENDPOINT, credenciales).then(response => {
...
export const crearUsuarioExtension = (usuarioEntidad) => {
    return new Promise((resolver, rechazar) => {
        axios.post(CREARUSUARIOEXTENSION_POST_ENDPOINT, usuarioEntidad)
...
export const crearUsuarioEstudiante = (usuarioEntidad) => {
    return new Promise((resolver, rechazar) => {
        axios.post(CREARUSUARIOESTUDIANTE_POST_ENDPOINT, usuarioEntidad)
            .then(response => resolver(response.data))
            .catch(err => rechazar(err))
    })
}
export const crearUsuarioDocente = (usuarioEntidad) => {
    return new Promise((resolver, rechazar) => {
        axios.post(CREARUSUARIODOCENTE_POST_ENDPOINT, usuarioEntidad)
            .then(response => resolver(response.data))
            .catch(err => rechazar(err))
    })
}
